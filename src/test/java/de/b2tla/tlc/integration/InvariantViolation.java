...
public class InvariantViolation extends AbstractParseMachineTest{

	private static final String PATH = "../probprivate/public_examples/TLC/InvariantViolation";
	
	private final File machine;
	
	public InvariantViolation(File machine){
