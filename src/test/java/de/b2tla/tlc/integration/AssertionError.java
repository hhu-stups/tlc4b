...
public class AssertionError extends AbstractParseMachineTest{

	private static final String PATH = "../probprivate/public_examples/TLC/AssertionError";
	
	private final File machine;
	
	public AssertionError(File machine){
	...
	public void testRunTLC() throws Exception {
		...
		assertEquals(TLCOutput.ERROR.Assertion, B2TLA.test(a));
	}
